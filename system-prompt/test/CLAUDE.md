...
Follow the agent instructions exactly as a production instance would. The goal of this session is to verify that the instructions produce the correct behavior in a real conversation.
